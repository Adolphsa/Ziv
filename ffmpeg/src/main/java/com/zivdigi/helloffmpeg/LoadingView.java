...
public class LoadingView extends View{
    ...
    public LoadingView(Context context, AttributeSet attrs) {
        ...
        // 自定义属性，attrs
        // 使用TypedArray
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ffPercentCircle);

        // 背景圆的半径
        mRadius = typedArray.getInt(R.styleable.ffPercentCircle_radius, mDefaultRadius);

        // 背景圆的颜色
        mBackgroundColor = typedArray.getColor(R.styleable.ffPercentCircle_circleBackground, mDefaultBackgroundColor);

        // 文字的颜色 默认白色
        mTextColor = typedArray.getColor(R.styleable.ffPercentCircle_textColor, mDefaultTextColor);

        // 外圆环的颜色
        mRingColor = typedArray.getColor(R.styleable.ffPercentCircle_ringColor, mDefaultRingColor);
    ...
    public void initPercentCircle(float currentPercent, float currentAngle){
        mCurrentPercent = currentPercent;
